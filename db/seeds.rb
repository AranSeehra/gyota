...
marco = Teacher.new(first_name: 'Marco', last_name: 'Ricci', location: 'London', bio: 'Batch Manager lewagon London', specialty: 'Web Dev', price: 45)
...
ife = Teacher.new(first_name: 'Ife', last_name: 'Odugbesan', location: 'Tokyo', bio: 'I love to lean. I love to develop. I love to code', specialty: 'Web Dev', price: 35)
